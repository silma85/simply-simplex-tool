...
public class Messages {
	...
	public static final String CONTACT_ME = HTML + Messages.getString("Constants.68") //$NON-NLS-1$
			+ HTML_END;
	public static final String VISIT_ME = HTML + Messages.getString("Constants.69") //$NON-NLS-1$
			+ HTML_END;
	public static final String INFORM_ME = HTML + Messages.getString("Constants.70") //$NON-NLS-1$
			+ HTML_END;
	public static final String WEBSITE = Messages.getString("Constants.71"); //$NON-NLS-1$

	public static final String EMAIL = Messages.getString("Constants.72"); //$NON-NLS-1$
}
